...
try {
	...
	$processor->start(new ShellClientProcess(new SleeperJob(2, $results[])));
	$processor->start(new ShellClientProcess(new SleeperJob(3, $results[])));
	$processor->start(new ShellClientProcess(new SleeperJob(1, $results[])));
